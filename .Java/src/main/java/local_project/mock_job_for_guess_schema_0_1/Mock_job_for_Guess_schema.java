	...
	public void tJavaFlex_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String url = "jdbc:mysql://relational.fit.cvut.cz:3306/AdventureWorks2014?noDatetimeStringSync=true&enabledTLSProtocols=TLSv1.2,TLSv1.1,TLSv1";
...
// Exception is thrown if db don't support, no need to catch exception here
				...
				java.sql.ResultSet rs = stm.executeQuery("select id, name from employee");
				java.sql.ResultSetMetaData rsmd = rs.getMetaData();
				int numbOfColumn = rsmd.getColumnCount();

				String fileName = (new java.io.File(
						"/home/kazumi/Downloads/TOS_DI-20211109_1610-V8.0.1/temp/tempGuessSchemaDelimitedFile.csv"))
...
/************************************************************************************************
 * 31167 characters generated by Talend Open Studio for Data Integration on the
 * February 16, 2022 at 10:01:39 PM BRT
 ************************************************************************************************/